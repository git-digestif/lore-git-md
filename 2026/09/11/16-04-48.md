# Re: [GIT PULL] gitk: discourage AI, color preference dialog

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | Johannes Sixt <j6t@kdbg.org> |
| **Date** | 2026-09-11T09:04:48-07:00 |
| **Message-ID** | [xmqq8q57dba7.fsf@gitster.g](https://lore.kernel.org/git/xmqq8q57dba7.fsf@gitster.g) |

---

**Thread**: [thread](07-17-06.thread.md#:~:text=2026/09/11/16-04-48)

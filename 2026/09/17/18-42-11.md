# [PATCH v5 0/3] sequencer: leave auto maintenance to the end of a sequence

| Header | Value |
|--------|-------|
| **From** | Thomas Bachem via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-09-17T18:42:11Z |
| **Message-ID** | [pull.2217.v5.git.1789670534.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.2217.v5.git.1789670534.gitgitgadget@gmail.com) |

---

**Thread**: [thread](../04/07-53-44.thread.md#:~:text=2026/09/17/18-42-11)

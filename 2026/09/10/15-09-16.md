# [PATCH v5 6/9] builtin/clone: move setup of alternates for non-shared local clones

| Header | Value |
|--------|-------|
| **From** | Patrick Steinhardt <ps@pks.im> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-09-10T17:09:16+02:00 |
| **Message-ID** | [20260910-pks-odb-write-alternates-at-creation-time-v5-6-8d10c4238edc@pks.im](https://lore.kernel.org/git/20260910-pks-odb-write-alternates-at-creation-time-v5-6-8d10c4238edc@pks.im) |

---

**Thread**: [thread](../../08/25/14-11-49.thread.md#:~:text=2026/09/10/15-09-16)

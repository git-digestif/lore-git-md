# Re: [PATCH v4 2/9] builtin/clone: defer setup of the object database

| Header | Value |
|--------|-------|
| **From** | Karthik Nayak <karthik.188@gmail.com> |
| **To** | Patrick Steinhardt <ps@pks.im>, git@vger.kernel.org |
| **Date** | 2026-09-10T02:28:20-07:00 |
| **Message-ID** | [CAOLa=ZSH5WtAej++SuWhupLjYv_rLQs8cCcXgETNjLH7_mkZyA@mail.gmail.com](https://lore.kernel.org/git/CAOLa=ZSH5WtAej++SuWhupLjYv_rLQs8cCcXgETNjLH7_mkZyA@mail.gmail.com) |

---

**Thread**: [thread](../../08/25/14-11-49.thread.md#:~:text=2026/09/10/09-28-20)

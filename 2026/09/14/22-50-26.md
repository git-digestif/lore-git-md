# [PATCH v8] var: support broken-down idents, signing key, multiple args, and -z

| Header | Value |
|--------|-------|
| **From** | Andrew Pleeter via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-09-14T22:50:26Z |
| **Message-ID** | [pull.2388.v8.git.git.1789426226860.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.2388.v8.git.git.1789426226860.gitgitgadget@gmail.com) |

---

**Thread**: [thread](../../08/25/20-46-42.thread.md#:~:text=2026/09/14/22-50-26)

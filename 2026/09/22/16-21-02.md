# [ANNOUNCE] Git v2.56.0-rc2

| Header | Value |
|--------|-------|
| **From** | Junio C Hamano <gitster@pobox.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-09-22T09:21:02-07:00 |
| **Message-ID** | [xmqqld8tfea9.fsf@gitster.g](https://lore.kernel.org/git/xmqqld8tfea9.fsf@gitster.g) |

---

**Thread**: [thread](16-21-02.thread.md#:~:text=2026/09/22/16-21-02)

A release candidate Git v2.56.0-rc2 is now available for testing at
the usual places.  It is comprised of 728 non-merge commits since
v2.55.0, contributed by 92 people, 36 of which are new faces [*].
...
'v2.56.0-rc2' tag and the 'master' branch that the tag points at:
...
```
  ...
  Lira de Freitas, and xuqing yang.
...
```
  ...
  Mantas Mikulėnas, Matt Hunter, Michael Montalbo, Miklos
  Vajna, Olamide Caleb Bello, Pablo Sabater, Patrick Steinhardt,
  Peter Colberg, Philip Oakley, Phillip Wood, Randall Becker,
  René Scharfe, Sahitya Chandra, Shardul Natu, Siddharth

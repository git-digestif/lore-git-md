# [PATCH v3 0/4] fetch: avoid fetching every branch of a new remote in a shallow repo

| Header | Value |
|--------|-------|
| **From** | Harald Nordgren via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-09-25T10:49:58Z |
| **Message-ID** | [pull.2412.v3.git.git.1790333402.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.2412.v3.git.git.1790333402.gitgitgadget@gmail.com) |

---

**Thread**: [thread](../19/14-47-26.thread.md#:~:text=2026/09/25/10-49-58)

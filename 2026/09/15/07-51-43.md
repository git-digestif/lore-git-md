# [PATCH v3] range-diff: add --matched-only to skip one-sided commits

| Header | Value |
|--------|-------|
| **From** | Harald Nordgren via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | git@vger.kernel.org |
| **Date** | 2026-09-15T07:51:43Z |
| **Message-ID** | [pull.2401.v3.git.git.1789458703432.gitgitgadget@gmail.com](https://lore.kernel.org/git/pull.2401.v3.git.git.1789458703432.gitgitgadget@gmail.com) |

---

**Thread**: [thread](../11/16-41-17.thread.md#:~:text=2026/09/15/07-51-43)
